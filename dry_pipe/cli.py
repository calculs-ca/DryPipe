...
class Cli:
    ...
    def _enumerate_commands(self):
        ...
        yield Command('list-keys', pipeline_instance_dir, generator, filter,
                      help="list keys in the pipeline instance that can possibly generated by the DAG")

        yield Command('summary', pipeline_instance_dir, filter,
    ...
    def summary(self):
        ...
        for state_file in Path(pid).glob(".drypipe/*/state.*"):
            s = state_file.relative_to(pid)
            print(f"{s}")
