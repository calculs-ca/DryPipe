...
class Pipeline:
    ...
    def create_pipeline_instance(self, pipeline_instance_dir, logger=None, instance_log_level="INFO"):
        return PipelineInstance(self, pipeline_instance_dir, logger, instance_log_level=instance_log_level)
